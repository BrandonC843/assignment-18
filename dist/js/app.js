...
function createCarpoolPageTemplate(dataArray) {
   var largeHTMLString2 = ['<div class="panel panel-default">', '<div class = "panel-heading">carpools</div>'];
...
function controllerRouter() {
   ...
   if (currentRoute === 'flights') {
      ...
      var arrivals = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals').then(function (arrivalRes) {
         var departures = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures').then(function (departRes) {
